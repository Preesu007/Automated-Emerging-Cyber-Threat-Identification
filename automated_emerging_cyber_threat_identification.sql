...
--
-- Database: `automated_emerging_cyber_threat_identification`
--
CREATE DATABASE IF NOT EXISTS `automated_emerging_cyber_threat_identification` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `automated_emerging_cyber_threat_identification`;
...
('bqlj7xucow70vu8nfyq3dhwhdy0l4qs5', 'eyJ1c2VyaWQiOjJ9:1pMqCl:3eX6lu-Xe6hHgKc1_QmLBy3SBqVSBxaqxET2i5mo0TI', '2023-02-14 12:57:43.646279'),
...
('s3dmfrvqwhvsjz043iaxknqs4ae50g3p', 'eyJ1c2VyaWQiOjJ9:1qkkFd:wZXO7DR3TdFAw1IcV-6zzfdIS75Skv1oNbKO-qUlTZA', '2023-10-09 11:59:45.756541'),
...
('tmfl0s53v7byz3rped1ma47uidrymg25', 'eyJ1c2VyaWQiOjF9:1pMp70:3H1mSw4DkeeLquxp0sVGJ0l9K-j5xvQ47gv86gIt_xM', '2023-02-14 11:47:42.214039'),
...
('yttaquxeqmx5krxts351b2hpo2ncu1c5', 'eyJ1c2VyaWQiOjF9:1qkinx:fCeksKGVbmlbvjkxqOMet9ZsZoq8jKnUg5-ptEjHVtg', '2023-10-09 10:27:05.850284'),
...
(1, 'Govind', 'Govind123@gmail.com', 'Govind', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju19@gmail.com', 'Manjunath', '9535866270', 'India', 'karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_cyber_threat_identification`
--
...
--
-- Dumping data for table `remote_user_cyber_threat_identification`
--

INSERT INTO `remote_user_cyber_threat_identification` (`id`, `fid`, `tweet_text`, `timestamp`, `source`, `symbols`, `company_names`, `url`, `source_ip`, `protocol`, `dest_ip`, `Prediction`) VALUES
(1, '43806068\n', 'Alcoa cuts adjusted EBITDA forecast citing tariffs shares slide https://t.co/mdMJXjnYIs https://t.co/5O8fvwlHpY\r\n', 'Wed Jul 18 23:24:09 +0000 2018', 'Reuters', 'HPQ', 'HP', 'https://reut.rs/2NZoM1r', '149.171.126.11', 'sctp', '175.45.176.1', 'Cyber Threat Found'),
(2, '44099539', 'Traders Sell Rockwell Collins $COL on Strength $COL https://t.co/ApcJE6R9wC\r\n', 'Mon Jul 09 23:19:20 +0000 2018', 'MareaInformativ', 'COL', 'Rockwell Collins', 'http://www.mareainformativa.com/?p=412800', '149.171.126.2', 'udp', '59.166.0.6', 'No Cyber Threat Found'),
(3, '44100774', '$2.26 Billion in Sales Expected for Advance Auto Parts Inc. $AAP This Quarter https://t.co/p33PXuC6YY\r\n', 'Tue Jul 10 02:27:53 +0000 2018', 'MareaInformativ', 'AAP', 'Advance Auto Parts', 'http://www.mareainformativa.com/?p=413362', '149.171.126.0', 'udp', '59.166.0.5', 'Cyber Threat Found'),
(4, '44100666', 'Analysts See $0.17 EPS for Flex Ltd. $FLEX - https://t.co/uyNPQlJmDw\r\n', 'Tue Jul 10 02:07:04 +0000 2018', 'whatsonthorold2', 'FLEX', 'Flex Ltd.', 'https://www.whatsonthorold.com/2018/07/10/analysts-see-0-17-eps-for-flex-ltd-flex/', '149.171.126.5', 'udp', '59.166.0.5', 'No Cyber Threat Found'),
(5, '44099657', '$MR $FOE $IT $ATE $AT $SEAS $I $BIT $KIM\r\n', 'Mon Jul 09 23:44:30 +0000 2018', 'stockbard', 'KIM', 'Kimco Realty Corporation', 'Not Mentioned', '149.171.126.0', 'tcp', '59.166.0.9', 'No Cyber Threat Found'),
(6, '44102579', 'Torchmark $TMK Upgraded at Zacks Investment Research https://t.co/UZQDyElWMO\r\n', 'Tue Jul 10 07:05:27 +0000 2018', 'ThisLincolnian', 'TMK', 'Torchmark Corporation', 'http://thelincolnianonline.com/?p=2173484', '149.171.126.3', 'tcp', '59.166.0.9', 'Cyber Threat Found');
...
(26, 'Convolutional Neural Network--CNN', '78.87323943661971'),
(27, 'Extra Tree Classifier', '72.9264475743349'),
(28, 'SVM', '77.77777777777779'),
(29, 'Logistic Regression', '78.09076682316119'),
(30, 'Gradient Boosting Classifier', '75.8998435054773');
...
(16, 'Cyber Threat Found', '50.0'),
(17, 'No Cyber Threat Found', '50.0');
